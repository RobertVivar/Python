print("--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=")
print("		48.Interfaces.Graficas_VII ")
print("--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=")
# ----------------------------------------------------------------------------
...
boton5=Button(miFrame, text="5", width=3, command=lambda:numPulsado("3"))
boton5.grid(row=3,column=2)
boton6=Button(miFrame, text="6", width=3, command=lambda:numPulsado("2"))
...
botonPunto=Button(miFrame, text=".", command=lambda:numPulsado("."))
